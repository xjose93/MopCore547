...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        MoPCore::AnyUnitInObjectRangeCheck go_check(object, radius);
        MoPCore::CreatureListSearcher<MoPCore::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
        object->VisitNearbyGridObject(radius, go_search);
